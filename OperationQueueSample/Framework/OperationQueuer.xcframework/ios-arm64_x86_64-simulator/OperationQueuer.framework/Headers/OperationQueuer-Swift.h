...
#ifndef OPERATIONQUEUER_SWIFT_H
#define OPERATIONQUEUER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="OperationQueuer",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC15OperationQueuer19ConcurrentOperation")
...
SWIFT_CLASS("_TtC15OperationQueuer20SynchronousOperation")
